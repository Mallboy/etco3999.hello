...
const char PALETTE[32] =
  {
    0x04, // screen color
    0x1C, 0x33, 0x3C, 0x00, // background palette 0
    0x11, 0x24, 0x2C, 0x00, // background palette 1
    0x00, 0x1A, 0x20, 0x00, // background palette 2
    0x00, 0x1A, 0x20, 0x00, // background palette 3
    0x23, 0x31, 0x41, 0x00, // sprite palette 0
    0x07, 0x15, 0x17, 0x00, // sprite palette 1
...
DEF_METASPRITE_2x2(doorSprite, 0xc4, 0);
